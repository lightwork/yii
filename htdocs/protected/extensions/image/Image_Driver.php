...
abstract class Image_Driver {
	...
	// Borrowed from http://kohanaframework.org/3.0/guide/api/Kohana_Image_GD#_do_watermark
	//abstract protected function watermark(Image $watermark, $offset_x, $offset_y, $opacity);
	abstract protected function watermark($properties);
