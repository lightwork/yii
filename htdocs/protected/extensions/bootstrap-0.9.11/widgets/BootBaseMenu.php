...
abstract class BootBaseMenu extends BootWidget
{
	...
	/**
	 * @var string The icon class for normal (non-active) menu items.
	 */
	public $iconNormalClass = 'icon-black';
	
	/**
	 * @var string The icon class for active menu items.
	 */
	public $iconActiveClass = 'icon-white';
	...
	protected function renderItem($item)
	{
		...
		if (isset($item['icon']))
		{
			...
			if ($item['active']) { $item['icon'] .= ' ' . $this->iconActiveClass; }
			else { $item['icon'] .= ' ' . $this->iconNormalClass; }
